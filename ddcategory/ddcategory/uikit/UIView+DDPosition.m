...
@implementation UIView (DDPosition)
@dynamic x, y, width, height, origin, size, boundCenterX, boundCenterY, boundCenter;
...
-(CGPoint)boundCenter {
    return CGPointMake([self boundCenterX], [self boundCenterY]);
}
